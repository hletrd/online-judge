...
export const JUDGE_LANGUAGE_CONFIGS: Record<Language, JudgeLanguageDefinition> = {
  ...
  whitespace: {
    ...
    compiler: "Whitespace Interpreter",
    compileCommand: null,
    runCommand: ["wspace", "/workspace/solution.ws"],
  },
  befunge: {
    language: "befunge",
    displayName: "Befunge",
  ...
  rockstar: {
    ...
    extension: ".rock",
    dockerImage: "judge-esoteric:latest",
    compiler: "Rockstar Interpreter",
    compileCommand: null,
    runCommand: ["rockstar", "/workspace/solution.rock"],
  },
  shakespeare: {
    ...
    extension: ".spl",
    dockerImage: "judge-esoteric:latest",
    compiler: "Shakespeare Interpreter",
    compileCommand: null,
    runCommand: ["shakespeare", "run", "/workspace/solution.spl"],
  },
  aheui: {
    language: "aheui",
